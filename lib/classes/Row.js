...
Row.prototype.availableSpace = function (parentSize) {
	// parentSize = parentSize || this.getParent().availableSpace(); // Uncomment for convenient code/unoptimization


	// divide: Math.floor(parentSize.height / (this.getSiblings().length + 1))
